package net.focik.userservice.domain.security.filter;
...
import static net.focik.userservice.domain.security.constant.SecurityConstant.ACCESS_DENIED_MESSAGE;
